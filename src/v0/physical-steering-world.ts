...
export class PhysicalSteeringWorld {
  ...
  #createFront(side: SteeringSide): FrontCornerRuntime {
    ...
    const steeringPickupLocal = vec3(
      -this.#geometry.steeringArmRadius,
      0,
      0,
    );
  ...
  trace(): PhysicalSteeringTrace {
    ...
    const oracle = solveSteeringOracle(this.#geometry, oracleRackTranslation);
