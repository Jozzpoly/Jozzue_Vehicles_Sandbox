...
export type SteeringVariantId = "A" | "B";
...
export interface SteeringGeometry {
  ...
  readonly steeringArmRadius: number;
}
...
> = Object.freeze({
  A: Object.freeze({ ...COMMON, id: "A", steeringArmRadius: 0.18 }),
  B: Object.freeze({ ...COMMON, id: "B", steeringArmRadius: 0.3 }),
});
...
export function straightPickup(
  ...
  return {
    x: geometry.frontAxleX - geometry.steeringArmRadius,
...
function solveCorner(
  ...
  const radius = geometry.steeringArmRadius;
